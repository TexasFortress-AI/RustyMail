...
async fn test_mcp_tools_list() {
    ...
    assert_eq!(tools.len(), 28, "Should have exactly 28 tools");
    ...
    let expected_tool_names = vec![
        ...
        "sync_emails", "search_by_attachment_type"
    ];
...
async fn test_mcp_dashboard_api_consistency() {
    ...
    assert_eq!(mcp_tools.len(), 28, "Should have 28 tools in both interfaces");
