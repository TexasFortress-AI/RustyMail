...
import SamplerConfigPanel from './SamplerConfigPanel';
    ...
    >
      ...
      >
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col min-h-0">
          ...
          {/* Models Tab */}
          <TabsContent value="models" className="flex-1 flex flex-col min-h-0 mt-0 data-[state=inactive]:hidden">
            <Tabs defaultValue="models-config" className="flex-1 flex flex-col min-h-0">
              <TabsList className="grid w-full max-w-md grid-cols-2 mb-4">
                <TabsTrigger value="models-config">Model Selection</TabsTrigger>
                <TabsTrigger value="sampler-config">Sampler Settings</TabsTrigger>
              </TabsList>
              <TabsContent value="models-config" className="flex-1 min-h-0 overflow-auto mt-0">
                <ModelsPanel />
              </TabsContent>
              <TabsContent value="sampler-config" className="flex-1 min-h-0 overflow-auto mt-0">
                <SamplerConfigPanel />
              </TabsContent>
            </Tabs>
          </TabsContent>
